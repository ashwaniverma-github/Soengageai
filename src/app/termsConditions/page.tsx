  ...
  return (
    <div className="bg-gray-100 text-black p-6 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4">
          These terms and conditions outline the rules and regulations for the use of soengageai.com&apos;s Website, located at soengageai@gmail.com.
        </p>
        <p className="mb-4">
          By accessing this website, we assume you accept these terms and conditions. Do not continue to use soengageai.com if you do not agree to take all of the terms and conditions stated on this page.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          We employ the use of cookies. By accessing soengageai.com, you agreed to use cookies in agreement with soengageai.com&apos;s Privacy Policy.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Unless otherwise stated, soengageai.com and/or its licensors own the intellectual property rights for all material on soengageai.com. All intellectual property rights are reserved. You may access this from soengageai.com for your own personal use subject to restrictions set in these terms and conditions.
        </p>
        <p className="mb-4">You must not:</p>
        <ul className="list-disc list-inside mb-4">
          <li>Republish material from soengageai.com</li>
          <li>Sell, rent, or sub-license material from soengageai.com</li>
          <li>Reproduce, duplicate, or copy material from soengageai.com</li>
          <li>Redistribute content from soengageai.com</li>
        </ul>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold mb-2">iFrames</h3>
        <p className="mb-4">
